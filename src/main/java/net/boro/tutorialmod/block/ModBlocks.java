package net.boro.tutorialmod.block;

import net.boro.tutorialmod.TutorialMod;
import net.boro.tutorialmod.item.ModItems;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ROSEWOOD_PLANKS = registerBlock("rosewood_planks", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).noParticlesOnBreak()));
